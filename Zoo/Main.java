    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (arrivingScanner.hasNextLine()) {
                ...
                if (newAnimal != null) {
                    animalList.add(newAnimal); // Add to ArrayList
            ...
            // Loop through our filled ArrayList and write each animal to the file
            ...
            // Loop through our HashMap to print the totals
            for (String key : speciesCount.keySet()) {
                printWriter.println(key + ": " + speciesCount.get(key));
            }

            // Always close your writer to save the file!
            printWriter.close();
            System.out.println("Successfully created newAnimals.txt report!");

            // We catch FileNotFoundException for reading, and IOException for writing
